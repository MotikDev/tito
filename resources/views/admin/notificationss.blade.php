            ...
            <div class="container-fluid mt--7">
                ...
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <div class="card-header text-center">
                                <h1 class="text-primary">Signups</h1>
                            ...
                            <div class="table-responsive">
                                    <table class="table align-items-center table-flush">
                                        ...
                                        <tbody>
                                          ...
                                          @if ($notification->type == 'App\Notifications\SignUp')
                                              <tr>
                                                <th scope="row">
                                                    {{ $notification->data[0]['id'] }}
                                                </th>
                                                <td>
                                                    {{ $notification->data[0]['firstName'] }} {{ $notification->data[0]['lastName'] }}
                                                </td>
                                                <td>
                                                <span class="badge badge-dot mr-4">
                                                    {{ $notification->data[0]['phone'] }}
                                                </span>
                                                </td>
                                                <td>
                                                    {{ $notification->data[0]['email'] }}
                                                </td>
                                                <td class="text-right">
                                                    {{ $notification->data[0]['address1'] }} {{ $notification->data[0]['address2'] }}, {{ $notification->data[0]['city'] }}, {{ $notification->data[0]['state'] }}, {{ $notification->data[0]['zip'] }}
                                                </td>
                                                <td>
