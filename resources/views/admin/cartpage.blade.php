                ...
                <div class="row">
                    <div class="col">
                        <div class="card shadow">
                            ...
                            <h1 class="mb-0">Cart Page Fixed Contents</h1>
                            </div>

                            <hr>
                            <form class="px-5">
                                <div class="form-group">
                                    <input type="text" name="cartDescrip" id="cardDescrip" class="form-control" value="Very us move be blessed multiply night">
                                </div>
