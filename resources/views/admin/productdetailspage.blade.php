                ...
                <div class="row">
                    <div class="col">
                        <div class="card shadow">
                            ...
                            <h1 class="mb-0">Product Details Page Fixed Contents</h1>
                            </div>

                            <hr>
                            <form class="px-5">
                                <div class="form-group">
                                    <input type="text" name="detailsDescrip" id="detailsDescrip" class="form-control" value="Personalized description of detals page.">
                                </div>
