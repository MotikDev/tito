            ...
            <div class="container-fluid mt--7">
                ...
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <div class="card-header text-center">
                                <h1 class="text-primary">Checkout Page Orders</h1>
                                    ...
                                    <table class="table align-items-center table-flush">
                                        ...
                                        <tbody>
                                          @foreach ($user->notifications()->paginate(10) as $i => $notification)
                                            @if ($notification->type == 'App\Notifications\CartItemAdded')
                                              <tr>
                                                ...
                                                {{-- <div class="media align-items-center">
                                                    <div class="media-body">
                                                            <div class="avatar-group">
                                                                ...
                                                                <img alt="Image placeholder" src="../img/logo.jpg" class="rounded-circle">
                                                                </a>
                                                            </div>                                                    </div>
                                                </div> --}}
                                                </th>
                                                ...
                                                <span class="badge badge-dot mr-4">
                                                    {{ $notification->data[0]['phoneNumber'] }}
                                                </span>
                                                </td>
                                                <td>
                                                    {{ $notification->data[0]['orderItems'] }}
                                                </td>
                                                <td class="text-right">
                                            ...
                                            @endif
                                          @endforeach
                                            {{-- {{ $user->notifications()->paginate(1) }} --}}
                                            {{-- @for ($i = 0; $i < count($user->notifications)->paginate(1); $i++)
