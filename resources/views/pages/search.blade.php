        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md">
                    <h3>Search results for "{{ $searchQ }}"</h3>
                ...
                @for ($i = 0; $i < count($products); $i = $i + 3)
                    <div class="row mb-5" id="sortResults">
                      <div class="col">
                          <div class="card-deck">
                              <div class="card">
                                <a href="{{ route('details', ['id' => $products[$i]->id]) }}">
                                    <img src="{{ asset("storage/".$products[$i]->frontPicture."") }}" class="card-img-top" alt="...">
                                </a>

                                  <div class="card-body">
                                        <p class="card-text">
                                            {{ $products[$i]->brand }} {{ $products[$i]->product }}
                                        </p>
                                        <hr>
                                        <a href="https://api.whatsapp.com/send?phone=2348134673765&text=Product Details with Price" class="btn btn-default">
                                            ₦ {{ $products[$i]->price }} &nbsp; <img src="../img/whatsapp.png" width="20px" height="20px" class="float-right" alt="">
                                        </a>
                                  </div>
                              </div>
                              @if ($products[$i+1])
                                <div class="card">
                                    <a href="{{ route('details', ['id' => $products[$i+1]->id]) }}">
                                        <img src="{{ asset("storage/".$products[$i+1]->frontPicture."") }}" class="card-img-top" alt="...">
                                    </a>
                                    <div class="card-body">
                                        <p class="card-text">
                                            {{ $products[$i+1]->brand }} {{ $products[$i+1]->product }}
                                        </p>
                                        <hr>
                                        <a href="https://api.whatsapp.com/send?phone=2348134673765&text=Product Details with Price" class="btn btn-default">
                                            ₦ {{ $products[$i+1]->price }} &nbsp; <img src="../img/whatsapp.png" width="20px" height="20px" class="float-right" alt="">
                                        </a>
                                    </div>
                                </div>
                            @else
                            <div class="col-md-4"></div>
                              ...
                              @if ($products[$i+2])
                                <div class="card">
                                    <a href="{{ route('details', ['id' => $products[$i+2]->id]) }}">
                                        <img src="{{ asset("storage/".$products[$i+2]->frontPicture."") }}" class="card-img-top" alt="...">
                                    </a>
                                    <div class="card-body">
                                        <p class="card-text">
                                            {{ $products[$i+2]->brand }} {{ $products[$i+2]->product }}
                                        </p>
                                        <hr>
                                        <a href="https://api.whatsapp.com/send?phone=2348134673765&text=Product Details with Price" class="btn btn-default">
                                            ₦ {{ $products[$i+2]->price }} &nbsp; <img src="../img/whatsapp.png" width="20px" height="20px" class="float-right" alt="">
                                        </a>
                                    </div>
                                </div>
                            @else
